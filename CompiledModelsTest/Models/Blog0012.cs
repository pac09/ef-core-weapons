...
namespace Models
{
    public partial class Blog0012
    {
        public Blog0012()
        {
            Post0012Blog00s = new HashSet<Post0012>();
            Post0012Blog01s = new HashSet<Post0012>();
            Post0012Blog02s = new HashSet<Post0012>();
            Post0012Blog03s = new HashSet<Post0012>();
        }
        ...
        public virtual ICollection<Post0012> Post0012Blog00s { get; set; }
        public virtual ICollection<Post0012> Post0012Blog01s { get; set; }
        public virtual ICollection<Post0012> Post0012Blog02s { get; set; }
        public virtual ICollection<Post0012> Post0012Blog03s { get; set; }
    }
}
