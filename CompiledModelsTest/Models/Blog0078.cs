...
namespace Models
{
    public partial class Blog0078
    {
        public Blog0078()
        {
            Post0078Blog00s = new HashSet<Post0078>();
            Post0078Blog01s = new HashSet<Post0078>();
            Post0078Blog02s = new HashSet<Post0078>();
            Post0078Blog03s = new HashSet<Post0078>();
        }
        ...
        public virtual ICollection<Post0078> Post0078Blog00s { get; set; }
        public virtual ICollection<Post0078> Post0078Blog01s { get; set; }
        public virtual ICollection<Post0078> Post0078Blog02s { get; set; }
        public virtual ICollection<Post0078> Post0078Blog03s { get; set; }
    }
}
