...
namespace Models
{
    public partial class Blog0049
    {
        public Blog0049()
        {
            Post0049Blog00s = new HashSet<Post0049>();
            Post0049Blog01s = new HashSet<Post0049>();
            Post0049Blog02s = new HashSet<Post0049>();
            Post0049Blog03s = new HashSet<Post0049>();
        }
        ...
        public virtual ICollection<Post0049> Post0049Blog00s { get; set; }
        public virtual ICollection<Post0049> Post0049Blog01s { get; set; }
        public virtual ICollection<Post0049> Post0049Blog02s { get; set; }
        public virtual ICollection<Post0049> Post0049Blog03s { get; set; }
    }
}
