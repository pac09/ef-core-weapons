...
namespace Models
{
    public partial class Blog0058
    {
        public Blog0058()
        {
            Post0058Blog00s = new HashSet<Post0058>();
            Post0058Blog01s = new HashSet<Post0058>();
            Post0058Blog02s = new HashSet<Post0058>();
            Post0058Blog03s = new HashSet<Post0058>();
        }
        ...
        public virtual ICollection<Post0058> Post0058Blog00s { get; set; }
        public virtual ICollection<Post0058> Post0058Blog01s { get; set; }
        public virtual ICollection<Post0058> Post0058Blog02s { get; set; }
        public virtual ICollection<Post0058> Post0058Blog03s { get; set; }
    }
}
