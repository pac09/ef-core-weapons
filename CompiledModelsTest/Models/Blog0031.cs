...
namespace Models
{
    public partial class Blog0031
    {
        public Blog0031()
        {
            Post0031Blog00s = new HashSet<Post0031>();
            Post0031Blog01s = new HashSet<Post0031>();
            Post0031Blog02s = new HashSet<Post0031>();
            Post0031Blog03s = new HashSet<Post0031>();
        }
        ...
        public virtual ICollection<Post0031> Post0031Blog00s { get; set; }
        public virtual ICollection<Post0031> Post0031Blog01s { get; set; }
        public virtual ICollection<Post0031> Post0031Blog02s { get; set; }
        public virtual ICollection<Post0031> Post0031Blog03s { get; set; }
    }
}
