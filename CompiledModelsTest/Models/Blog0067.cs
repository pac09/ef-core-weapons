...
namespace Models
{
    public partial class Blog0067
    {
        public Blog0067()
        {
            Post0067Blog00s = new HashSet<Post0067>();
            Post0067Blog01s = new HashSet<Post0067>();
            Post0067Blog02s = new HashSet<Post0067>();
            Post0067Blog03s = new HashSet<Post0067>();
        }
        ...
        public virtual ICollection<Post0067> Post0067Blog00s { get; set; }
        public virtual ICollection<Post0067> Post0067Blog01s { get; set; }
        public virtual ICollection<Post0067> Post0067Blog02s { get; set; }
        public virtual ICollection<Post0067> Post0067Blog03s { get; set; }
    }
}
