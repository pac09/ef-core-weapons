...
namespace Models
{
    public partial class Blog0022
    {
        public Blog0022()
        {
            Post0022Blog00s = new HashSet<Post0022>();
            Post0022Blog01s = new HashSet<Post0022>();
            Post0022Blog02s = new HashSet<Post0022>();
            Post0022Blog03s = new HashSet<Post0022>();
        }
        ...
        public virtual ICollection<Post0022> Post0022Blog00s { get; set; }
        public virtual ICollection<Post0022> Post0022Blog01s { get; set; }
        public virtual ICollection<Post0022> Post0022Blog02s { get; set; }
        public virtual ICollection<Post0022> Post0022Blog03s { get; set; }
    }
}
