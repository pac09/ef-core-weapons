...
namespace Models
{
    public partial class Blog0079
    {
        public Blog0079()
        {
            Post0079Blog00s = new HashSet<Post0079>();
            Post0079Blog01s = new HashSet<Post0079>();
            Post0079Blog02s = new HashSet<Post0079>();
            Post0079Blog03s = new HashSet<Post0079>();
        }
        ...
        public virtual ICollection<Post0079> Post0079Blog00s { get; set; }
        public virtual ICollection<Post0079> Post0079Blog01s { get; set; }
        public virtual ICollection<Post0079> Post0079Blog02s { get; set; }
        public virtual ICollection<Post0079> Post0079Blog03s { get; set; }
    }
}
