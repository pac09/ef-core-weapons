...
namespace Models
{
    public partial class Blog0057
    {
        public Blog0057()
        {
            Post0057Blog00s = new HashSet<Post0057>();
            Post0057Blog01s = new HashSet<Post0057>();
            Post0057Blog02s = new HashSet<Post0057>();
            Post0057Blog03s = new HashSet<Post0057>();
        }
        ...
        public virtual ICollection<Post0057> Post0057Blog00s { get; set; }
        public virtual ICollection<Post0057> Post0057Blog01s { get; set; }
        public virtual ICollection<Post0057> Post0057Blog02s { get; set; }
        public virtual ICollection<Post0057> Post0057Blog03s { get; set; }
    }
}
