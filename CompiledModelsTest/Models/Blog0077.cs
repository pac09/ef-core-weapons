...
namespace Models
{
    public partial class Blog0077
    {
        public Blog0077()
        {
            Post0077Blog00s = new HashSet<Post0077>();
            Post0077Blog01s = new HashSet<Post0077>();
            Post0077Blog02s = new HashSet<Post0077>();
            Post0077Blog03s = new HashSet<Post0077>();
        }
        ...
        public virtual ICollection<Post0077> Post0077Blog00s { get; set; }
        public virtual ICollection<Post0077> Post0077Blog01s { get; set; }
        public virtual ICollection<Post0077> Post0077Blog02s { get; set; }
        public virtual ICollection<Post0077> Post0077Blog03s { get; set; }
    }
}
