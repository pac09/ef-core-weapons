...
namespace Models
{
    public partial class Blog0002
    {
        public Blog0002()
        {
            Post0002Blog00s = new HashSet<Post0002>();
            Post0002Blog01s = new HashSet<Post0002>();
            Post0002Blog02s = new HashSet<Post0002>();
            Post0002Blog03s = new HashSet<Post0002>();
        }
        ...
        public virtual ICollection<Post0002> Post0002Blog00s { get; set; }
        public virtual ICollection<Post0002> Post0002Blog01s { get; set; }
        public virtual ICollection<Post0002> Post0002Blog02s { get; set; }
        public virtual ICollection<Post0002> Post0002Blog03s { get; set; }
    }
}
