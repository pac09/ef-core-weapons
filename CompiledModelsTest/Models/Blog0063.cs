...
namespace Models
{
    public partial class Blog0063
    {
        public Blog0063()
        {
            Post0063Blog00s = new HashSet<Post0063>();
            Post0063Blog01s = new HashSet<Post0063>();
            Post0063Blog02s = new HashSet<Post0063>();
            Post0063Blog03s = new HashSet<Post0063>();
        }
        ...
        public virtual ICollection<Post0063> Post0063Blog00s { get; set; }
        public virtual ICollection<Post0063> Post0063Blog01s { get; set; }
        public virtual ICollection<Post0063> Post0063Blog02s { get; set; }
        public virtual ICollection<Post0063> Post0063Blog03s { get; set; }
    }
}
