...
namespace Models
{
    public partial class Blog0043
    {
        public Blog0043()
        {
            Post0043Blog00s = new HashSet<Post0043>();
            Post0043Blog01s = new HashSet<Post0043>();
            Post0043Blog02s = new HashSet<Post0043>();
            Post0043Blog03s = new HashSet<Post0043>();
        }
        ...
        public virtual ICollection<Post0043> Post0043Blog00s { get; set; }
        public virtual ICollection<Post0043> Post0043Blog01s { get; set; }
        public virtual ICollection<Post0043> Post0043Blog02s { get; set; }
        public virtual ICollection<Post0043> Post0043Blog03s { get; set; }
    }
}
