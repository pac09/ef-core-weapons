...
namespace Models
{
    public partial class Blog0054
    {
        public Blog0054()
        {
            Post0054Blog00s = new HashSet<Post0054>();
            Post0054Blog01s = new HashSet<Post0054>();
            Post0054Blog02s = new HashSet<Post0054>();
            Post0054Blog03s = new HashSet<Post0054>();
        }
        ...
        public virtual ICollection<Post0054> Post0054Blog00s { get; set; }
        public virtual ICollection<Post0054> Post0054Blog01s { get; set; }
        public virtual ICollection<Post0054> Post0054Blog02s { get; set; }
        public virtual ICollection<Post0054> Post0054Blog03s { get; set; }
    }
}
