...
namespace Models
{
    public partial class Blog0027
    {
        public Blog0027()
        {
            Post0027Blog00s = new HashSet<Post0027>();
            Post0027Blog01s = new HashSet<Post0027>();
            Post0027Blog02s = new HashSet<Post0027>();
            Post0027Blog03s = new HashSet<Post0027>();
        }
        ...
        public virtual ICollection<Post0027> Post0027Blog00s { get; set; }
        public virtual ICollection<Post0027> Post0027Blog01s { get; set; }
        public virtual ICollection<Post0027> Post0027Blog02s { get; set; }
        public virtual ICollection<Post0027> Post0027Blog03s { get; set; }
    }
}
