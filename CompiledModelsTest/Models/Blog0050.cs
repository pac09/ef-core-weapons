...
namespace Models
{
    public partial class Blog0050
    {
        public Blog0050()
        {
            Post0050Blog00s = new HashSet<Post0050>();
            Post0050Blog01s = new HashSet<Post0050>();
            Post0050Blog02s = new HashSet<Post0050>();
            Post0050Blog03s = new HashSet<Post0050>();
        }
        ...
        public virtual ICollection<Post0050> Post0050Blog00s { get; set; }
        public virtual ICollection<Post0050> Post0050Blog01s { get; set; }
        public virtual ICollection<Post0050> Post0050Blog02s { get; set; }
        public virtual ICollection<Post0050> Post0050Blog03s { get; set; }
    }
}
