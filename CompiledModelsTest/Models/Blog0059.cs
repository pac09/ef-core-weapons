...
namespace Models
{
    public partial class Blog0059
    {
        public Blog0059()
        {
            Post0059Blog00s = new HashSet<Post0059>();
            Post0059Blog01s = new HashSet<Post0059>();
            Post0059Blog02s = new HashSet<Post0059>();
            Post0059Blog03s = new HashSet<Post0059>();
        }
        ...
        public virtual ICollection<Post0059> Post0059Blog00s { get; set; }
        public virtual ICollection<Post0059> Post0059Blog01s { get; set; }
        public virtual ICollection<Post0059> Post0059Blog02s { get; set; }
        public virtual ICollection<Post0059> Post0059Blog03s { get; set; }
    }
}
