...
namespace Models
{
    public partial class Blog0025
    {
        public Blog0025()
        {
            Post0025Blog00s = new HashSet<Post0025>();
            Post0025Blog01s = new HashSet<Post0025>();
            Post0025Blog02s = new HashSet<Post0025>();
            Post0025Blog03s = new HashSet<Post0025>();
        }
        ...
        public virtual ICollection<Post0025> Post0025Blog00s { get; set; }
        public virtual ICollection<Post0025> Post0025Blog01s { get; set; }
        public virtual ICollection<Post0025> Post0025Blog02s { get; set; }
        public virtual ICollection<Post0025> Post0025Blog03s { get; set; }
    }
}
