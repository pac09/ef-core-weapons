...
namespace Models
{
    public partial class Blog0024
    {
        public Blog0024()
        {
            Post0024Blog00s = new HashSet<Post0024>();
            Post0024Blog01s = new HashSet<Post0024>();
            Post0024Blog02s = new HashSet<Post0024>();
            Post0024Blog03s = new HashSet<Post0024>();
        }
        ...
        public virtual ICollection<Post0024> Post0024Blog00s { get; set; }
        public virtual ICollection<Post0024> Post0024Blog01s { get; set; }
        public virtual ICollection<Post0024> Post0024Blog02s { get; set; }
        public virtual ICollection<Post0024> Post0024Blog03s { get; set; }
    }
}
