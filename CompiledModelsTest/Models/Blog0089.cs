...
namespace Models
{
    public partial class Blog0089
    {
        public Blog0089()
        {
            Post0089Blog00s = new HashSet<Post0089>();
            Post0089Blog01s = new HashSet<Post0089>();
            Post0089Blog02s = new HashSet<Post0089>();
            Post0089Blog03s = new HashSet<Post0089>();
        }
        ...
        public virtual ICollection<Post0089> Post0089Blog00s { get; set; }
        public virtual ICollection<Post0089> Post0089Blog01s { get; set; }
        public virtual ICollection<Post0089> Post0089Blog02s { get; set; }
        public virtual ICollection<Post0089> Post0089Blog03s { get; set; }
    }
}
