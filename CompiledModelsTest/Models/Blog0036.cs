...
namespace Models
{
    public partial class Blog0036
    {
        public Blog0036()
        {
            Post0036Blog00s = new HashSet<Post0036>();
            Post0036Blog01s = new HashSet<Post0036>();
            Post0036Blog02s = new HashSet<Post0036>();
            Post0036Blog03s = new HashSet<Post0036>();
        }
        ...
        public virtual ICollection<Post0036> Post0036Blog00s { get; set; }
        public virtual ICollection<Post0036> Post0036Blog01s { get; set; }
        public virtual ICollection<Post0036> Post0036Blog02s { get; set; }
        public virtual ICollection<Post0036> Post0036Blog03s { get; set; }
    }
}
