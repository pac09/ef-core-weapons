...
namespace Models
{
    public partial class Blog0081
    {
        public Blog0081()
        {
            Post0081Blog00s = new HashSet<Post0081>();
            Post0081Blog01s = new HashSet<Post0081>();
            Post0081Blog02s = new HashSet<Post0081>();
            Post0081Blog03s = new HashSet<Post0081>();
        }
        ...
        public virtual ICollection<Post0081> Post0081Blog00s { get; set; }
        public virtual ICollection<Post0081> Post0081Blog01s { get; set; }
        public virtual ICollection<Post0081> Post0081Blog02s { get; set; }
        public virtual ICollection<Post0081> Post0081Blog03s { get; set; }
    }
}
