...
namespace Models
{
    public partial class Blog0075
    {
        public Blog0075()
        {
            Post0075Blog00s = new HashSet<Post0075>();
            Post0075Blog01s = new HashSet<Post0075>();
            Post0075Blog02s = new HashSet<Post0075>();
            Post0075Blog03s = new HashSet<Post0075>();
        }
        ...
        public virtual ICollection<Post0075> Post0075Blog00s { get; set; }
        public virtual ICollection<Post0075> Post0075Blog01s { get; set; }
        public virtual ICollection<Post0075> Post0075Blog02s { get; set; }
        public virtual ICollection<Post0075> Post0075Blog03s { get; set; }
    }
}
