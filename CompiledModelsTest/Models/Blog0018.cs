...
namespace Models
{
    public partial class Blog0018
    {
        public Blog0018()
        {
            Post0018Blog00s = new HashSet<Post0018>();
            Post0018Blog01s = new HashSet<Post0018>();
            Post0018Blog02s = new HashSet<Post0018>();
            Post0018Blog03s = new HashSet<Post0018>();
        }
        ...
        public virtual ICollection<Post0018> Post0018Blog00s { get; set; }
        public virtual ICollection<Post0018> Post0018Blog01s { get; set; }
        public virtual ICollection<Post0018> Post0018Blog02s { get; set; }
        public virtual ICollection<Post0018> Post0018Blog03s { get; set; }
    }
}
