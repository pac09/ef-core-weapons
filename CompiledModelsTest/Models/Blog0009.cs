...
namespace Models
{
    public partial class Blog0009
    {
        public Blog0009()
        {
            Post0009Blog00s = new HashSet<Post0009>();
            Post0009Blog01s = new HashSet<Post0009>();
            Post0009Blog02s = new HashSet<Post0009>();
            Post0009Blog03s = new HashSet<Post0009>();
        }
        ...
        public virtual ICollection<Post0009> Post0009Blog00s { get; set; }
        public virtual ICollection<Post0009> Post0009Blog01s { get; set; }
        public virtual ICollection<Post0009> Post0009Blog02s { get; set; }
        public virtual ICollection<Post0009> Post0009Blog03s { get; set; }
    }
}
