...
namespace Models
{
    public partial class Blog0074
    {
        public Blog0074()
        {
            Post0074Blog00s = new HashSet<Post0074>();
            Post0074Blog01s = new HashSet<Post0074>();
            Post0074Blog02s = new HashSet<Post0074>();
            Post0074Blog03s = new HashSet<Post0074>();
        }
        ...
        public virtual ICollection<Post0074> Post0074Blog00s { get; set; }
        public virtual ICollection<Post0074> Post0074Blog01s { get; set; }
        public virtual ICollection<Post0074> Post0074Blog02s { get; set; }
        public virtual ICollection<Post0074> Post0074Blog03s { get; set; }
    }
}
