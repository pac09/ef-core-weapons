...
namespace Models
{
    public partial class Blog0011
    {
        public Blog0011()
        {
            Post0011Blog00s = new HashSet<Post0011>();
            Post0011Blog01s = new HashSet<Post0011>();
            Post0011Blog02s = new HashSet<Post0011>();
            Post0011Blog03s = new HashSet<Post0011>();
        }
        ...
        public virtual ICollection<Post0011> Post0011Blog00s { get; set; }
        public virtual ICollection<Post0011> Post0011Blog01s { get; set; }
        public virtual ICollection<Post0011> Post0011Blog02s { get; set; }
        public virtual ICollection<Post0011> Post0011Blog03s { get; set; }
    }
}
