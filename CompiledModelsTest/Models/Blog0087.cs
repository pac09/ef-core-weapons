...
namespace Models
{
    public partial class Blog0087
    {
        public Blog0087()
        {
            Post0087Blog00s = new HashSet<Post0087>();
            Post0087Blog01s = new HashSet<Post0087>();
            Post0087Blog02s = new HashSet<Post0087>();
            Post0087Blog03s = new HashSet<Post0087>();
        }
        ...
        public virtual ICollection<Post0087> Post0087Blog00s { get; set; }
        public virtual ICollection<Post0087> Post0087Blog01s { get; set; }
        public virtual ICollection<Post0087> Post0087Blog02s { get; set; }
        public virtual ICollection<Post0087> Post0087Blog03s { get; set; }
    }
}
