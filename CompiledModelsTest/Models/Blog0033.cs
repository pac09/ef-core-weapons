...
namespace Models
{
    public partial class Blog0033
    {
        public Blog0033()
        {
            Post0033Blog00s = new HashSet<Post0033>();
            Post0033Blog01s = new HashSet<Post0033>();
            Post0033Blog02s = new HashSet<Post0033>();
            Post0033Blog03s = new HashSet<Post0033>();
        }
        ...
        public virtual ICollection<Post0033> Post0033Blog00s { get; set; }
        public virtual ICollection<Post0033> Post0033Blog01s { get; set; }
        public virtual ICollection<Post0033> Post0033Blog02s { get; set; }
        public virtual ICollection<Post0033> Post0033Blog03s { get; set; }
    }
}
