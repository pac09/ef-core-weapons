...
namespace Models
{
    public partial class Blog0020
    {
        public Blog0020()
        {
            Post0020Blog00s = new HashSet<Post0020>();
            Post0020Blog01s = new HashSet<Post0020>();
            Post0020Blog02s = new HashSet<Post0020>();
            Post0020Blog03s = new HashSet<Post0020>();
        }
        ...
        public virtual ICollection<Post0020> Post0020Blog00s { get; set; }
        public virtual ICollection<Post0020> Post0020Blog01s { get; set; }
        public virtual ICollection<Post0020> Post0020Blog02s { get; set; }
        public virtual ICollection<Post0020> Post0020Blog03s { get; set; }
    }
}
