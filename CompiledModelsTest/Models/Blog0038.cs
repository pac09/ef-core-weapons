...
namespace Models
{
    public partial class Blog0038
    {
        public Blog0038()
        {
            Post0038Blog00s = new HashSet<Post0038>();
            Post0038Blog01s = new HashSet<Post0038>();
            Post0038Blog02s = new HashSet<Post0038>();
            Post0038Blog03s = new HashSet<Post0038>();
        }
        ...
        public virtual ICollection<Post0038> Post0038Blog00s { get; set; }
        public virtual ICollection<Post0038> Post0038Blog01s { get; set; }
        public virtual ICollection<Post0038> Post0038Blog02s { get; set; }
        public virtual ICollection<Post0038> Post0038Blog03s { get; set; }
    }
}
