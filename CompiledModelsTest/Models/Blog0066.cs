...
namespace Models
{
    public partial class Blog0066
    {
        public Blog0066()
        {
            Post0066Blog00s = new HashSet<Post0066>();
            Post0066Blog01s = new HashSet<Post0066>();
            Post0066Blog02s = new HashSet<Post0066>();
            Post0066Blog03s = new HashSet<Post0066>();
        }
        ...
        public virtual ICollection<Post0066> Post0066Blog00s { get; set; }
        public virtual ICollection<Post0066> Post0066Blog01s { get; set; }
        public virtual ICollection<Post0066> Post0066Blog02s { get; set; }
        public virtual ICollection<Post0066> Post0066Blog03s { get; set; }
    }
}
