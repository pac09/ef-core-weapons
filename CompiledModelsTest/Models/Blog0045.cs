...
namespace Models
{
    public partial class Blog0045
    {
        public Blog0045()
        {
            Post0045Blog00s = new HashSet<Post0045>();
            Post0045Blog01s = new HashSet<Post0045>();
            Post0045Blog02s = new HashSet<Post0045>();
            Post0045Blog03s = new HashSet<Post0045>();
        }
        ...
        public virtual ICollection<Post0045> Post0045Blog00s { get; set; }
        public virtual ICollection<Post0045> Post0045Blog01s { get; set; }
        public virtual ICollection<Post0045> Post0045Blog02s { get; set; }
        public virtual ICollection<Post0045> Post0045Blog03s { get; set; }
    }
}
