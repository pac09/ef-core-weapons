...
namespace Models
{
    public partial class Blog0055
    {
        public Blog0055()
        {
            Post0055Blog00s = new HashSet<Post0055>();
            Post0055Blog01s = new HashSet<Post0055>();
            Post0055Blog02s = new HashSet<Post0055>();
            Post0055Blog03s = new HashSet<Post0055>();
        }
        ...
        public virtual ICollection<Post0055> Post0055Blog00s { get; set; }
        public virtual ICollection<Post0055> Post0055Blog01s { get; set; }
        public virtual ICollection<Post0055> Post0055Blog02s { get; set; }
        public virtual ICollection<Post0055> Post0055Blog03s { get; set; }
    }
}
