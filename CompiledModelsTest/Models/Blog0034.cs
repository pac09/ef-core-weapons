...
namespace Models
{
    public partial class Blog0034
    {
        public Blog0034()
        {
            Post0034Blog00s = new HashSet<Post0034>();
            Post0034Blog01s = new HashSet<Post0034>();
            Post0034Blog02s = new HashSet<Post0034>();
            Post0034Blog03s = new HashSet<Post0034>();
        }
        ...
        public virtual ICollection<Post0034> Post0034Blog00s { get; set; }
        public virtual ICollection<Post0034> Post0034Blog01s { get; set; }
        public virtual ICollection<Post0034> Post0034Blog02s { get; set; }
        public virtual ICollection<Post0034> Post0034Blog03s { get; set; }
    }
}
