...
namespace Models
{
    public partial class Blog0060
    {
        public Blog0060()
        {
            Post0060Blog00s = new HashSet<Post0060>();
            Post0060Blog01s = new HashSet<Post0060>();
            Post0060Blog02s = new HashSet<Post0060>();
            Post0060Blog03s = new HashSet<Post0060>();
        }
        ...
        public virtual ICollection<Post0060> Post0060Blog00s { get; set; }
        public virtual ICollection<Post0060> Post0060Blog01s { get; set; }
        public virtual ICollection<Post0060> Post0060Blog02s { get; set; }
        public virtual ICollection<Post0060> Post0060Blog03s { get; set; }
    }
}
