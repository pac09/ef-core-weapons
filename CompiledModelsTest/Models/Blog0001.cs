...
namespace Models
{
    public partial class Blog0001
    {
        public Blog0001()
        {
            Post0001Blog00s = new HashSet<Post0001>();
            Post0001Blog01s = new HashSet<Post0001>();
            Post0001Blog02s = new HashSet<Post0001>();
            Post0001Blog03s = new HashSet<Post0001>();
        }
        ...
        public virtual ICollection<Post0001> Post0001Blog00s { get; set; }
        public virtual ICollection<Post0001> Post0001Blog01s { get; set; }
        public virtual ICollection<Post0001> Post0001Blog02s { get; set; }
        public virtual ICollection<Post0001> Post0001Blog03s { get; set; }
    }
}
