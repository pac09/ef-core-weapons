...
namespace Models
{
    public partial class Blog0070
    {
        public Blog0070()
        {
            Post0070Blog00s = new HashSet<Post0070>();
            Post0070Blog01s = new HashSet<Post0070>();
            Post0070Blog02s = new HashSet<Post0070>();
            Post0070Blog03s = new HashSet<Post0070>();
        }
        ...
        public virtual ICollection<Post0070> Post0070Blog00s { get; set; }
        public virtual ICollection<Post0070> Post0070Blog01s { get; set; }
        public virtual ICollection<Post0070> Post0070Blog02s { get; set; }
        public virtual ICollection<Post0070> Post0070Blog03s { get; set; }
    }
}
