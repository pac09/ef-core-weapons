...
namespace Models
{
    public partial class Blog0005
    {
        public Blog0005()
        {
            Post0005Blog00s = new HashSet<Post0005>();
            Post0005Blog01s = new HashSet<Post0005>();
            Post0005Blog02s = new HashSet<Post0005>();
            Post0005Blog03s = new HashSet<Post0005>();
        }
        ...
        public virtual ICollection<Post0005> Post0005Blog00s { get; set; }
        public virtual ICollection<Post0005> Post0005Blog01s { get; set; }
        public virtual ICollection<Post0005> Post0005Blog02s { get; set; }
        public virtual ICollection<Post0005> Post0005Blog03s { get; set; }
    }
}
