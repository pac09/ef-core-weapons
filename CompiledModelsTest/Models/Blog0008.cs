...
namespace Models
{
    public partial class Blog0008
    {
        public Blog0008()
        {
            Post0008Blog00s = new HashSet<Post0008>();
            Post0008Blog01s = new HashSet<Post0008>();
            Post0008Blog02s = new HashSet<Post0008>();
            Post0008Blog03s = new HashSet<Post0008>();
        }
        ...
        public virtual ICollection<Post0008> Post0008Blog00s { get; set; }
        public virtual ICollection<Post0008> Post0008Blog01s { get; set; }
        public virtual ICollection<Post0008> Post0008Blog02s { get; set; }
        public virtual ICollection<Post0008> Post0008Blog03s { get; set; }
    }
}
