...
namespace Models
{
    public partial class Blog0023
    {
        public Blog0023()
        {
            Post0023Blog00s = new HashSet<Post0023>();
            Post0023Blog01s = new HashSet<Post0023>();
            Post0023Blog02s = new HashSet<Post0023>();
            Post0023Blog03s = new HashSet<Post0023>();
        }
        ...
        public virtual ICollection<Post0023> Post0023Blog00s { get; set; }
        public virtual ICollection<Post0023> Post0023Blog01s { get; set; }
        public virtual ICollection<Post0023> Post0023Blog02s { get; set; }
        public virtual ICollection<Post0023> Post0023Blog03s { get; set; }
    }
}
