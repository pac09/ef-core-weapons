...
namespace Models
{
    public partial class Blog0046
    {
        public Blog0046()
        {
            Post0046Blog00s = new HashSet<Post0046>();
            Post0046Blog01s = new HashSet<Post0046>();
            Post0046Blog02s = new HashSet<Post0046>();
            Post0046Blog03s = new HashSet<Post0046>();
        }
        ...
        public virtual ICollection<Post0046> Post0046Blog00s { get; set; }
        public virtual ICollection<Post0046> Post0046Blog01s { get; set; }
        public virtual ICollection<Post0046> Post0046Blog02s { get; set; }
        public virtual ICollection<Post0046> Post0046Blog03s { get; set; }
    }
}
