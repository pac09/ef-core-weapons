...
namespace Models
{
    public partial class Blog0082
    {
        public Blog0082()
        {
            Post0082Blog00s = new HashSet<Post0082>();
            Post0082Blog01s = new HashSet<Post0082>();
            Post0082Blog02s = new HashSet<Post0082>();
            Post0082Blog03s = new HashSet<Post0082>();
        }
        ...
        public virtual ICollection<Post0082> Post0082Blog00s { get; set; }
        public virtual ICollection<Post0082> Post0082Blog01s { get; set; }
        public virtual ICollection<Post0082> Post0082Blog02s { get; set; }
        public virtual ICollection<Post0082> Post0082Blog03s { get; set; }
    }
}
