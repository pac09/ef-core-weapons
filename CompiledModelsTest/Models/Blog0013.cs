...
namespace Models
{
    public partial class Blog0013
    {
        public Blog0013()
        {
            Post0013Blog00s = new HashSet<Post0013>();
            Post0013Blog01s = new HashSet<Post0013>();
            Post0013Blog02s = new HashSet<Post0013>();
            Post0013Blog03s = new HashSet<Post0013>();
        }
        ...
        public virtual ICollection<Post0013> Post0013Blog00s { get; set; }
        public virtual ICollection<Post0013> Post0013Blog01s { get; set; }
        public virtual ICollection<Post0013> Post0013Blog02s { get; set; }
        public virtual ICollection<Post0013> Post0013Blog03s { get; set; }
    }
}
