...
namespace Models
{
    public partial class Blog0019
    {
        public Blog0019()
        {
            Post0019Blog00s = new HashSet<Post0019>();
            Post0019Blog01s = new HashSet<Post0019>();
            Post0019Blog02s = new HashSet<Post0019>();
            Post0019Blog03s = new HashSet<Post0019>();
        }
        ...
        public virtual ICollection<Post0019> Post0019Blog00s { get; set; }
        public virtual ICollection<Post0019> Post0019Blog01s { get; set; }
        public virtual ICollection<Post0019> Post0019Blog02s { get; set; }
        public virtual ICollection<Post0019> Post0019Blog03s { get; set; }
    }
}
