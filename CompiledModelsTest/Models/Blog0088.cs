...
namespace Models
{
    public partial class Blog0088
    {
        public Blog0088()
        {
            Post0088Blog00s = new HashSet<Post0088>();
            Post0088Blog01s = new HashSet<Post0088>();
            Post0088Blog02s = new HashSet<Post0088>();
            Post0088Blog03s = new HashSet<Post0088>();
        }
        ...
        public virtual ICollection<Post0088> Post0088Blog00s { get; set; }
        public virtual ICollection<Post0088> Post0088Blog01s { get; set; }
        public virtual ICollection<Post0088> Post0088Blog02s { get; set; }
        public virtual ICollection<Post0088> Post0088Blog03s { get; set; }
    }
}
