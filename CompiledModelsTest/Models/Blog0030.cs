...
namespace Models
{
    public partial class Blog0030
    {
        public Blog0030()
        {
            Post0030Blog00s = new HashSet<Post0030>();
            Post0030Blog01s = new HashSet<Post0030>();
            Post0030Blog02s = new HashSet<Post0030>();
            Post0030Blog03s = new HashSet<Post0030>();
        }
        ...
        public virtual ICollection<Post0030> Post0030Blog00s { get; set; }
        public virtual ICollection<Post0030> Post0030Blog01s { get; set; }
        public virtual ICollection<Post0030> Post0030Blog02s { get; set; }
        public virtual ICollection<Post0030> Post0030Blog03s { get; set; }
    }
}
