...
namespace Models
{
    public partial class Post0065
    {
        ...
        public virtual Blog0065? Blog00 { get; set; }
        public virtual Blog0065? Blog01 { get; set; }
        public virtual Blog0065? Blog02 { get; set; }
        public virtual Blog0065? Blog03 { get; set; }
    }
}
