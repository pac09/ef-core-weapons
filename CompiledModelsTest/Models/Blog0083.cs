...
namespace Models
{
    public partial class Blog0083
    {
        public Blog0083()
        {
            Post0083Blog00s = new HashSet<Post0083>();
            Post0083Blog01s = new HashSet<Post0083>();
            Post0083Blog02s = new HashSet<Post0083>();
            Post0083Blog03s = new HashSet<Post0083>();
        }
        ...
        public virtual ICollection<Post0083> Post0083Blog00s { get; set; }
        public virtual ICollection<Post0083> Post0083Blog01s { get; set; }
        public virtual ICollection<Post0083> Post0083Blog02s { get; set; }
        public virtual ICollection<Post0083> Post0083Blog03s { get; set; }
    }
}
