...
namespace Models
{
    public partial class Blog0039
    {
        public Blog0039()
        {
            Post0039Blog00s = new HashSet<Post0039>();
            Post0039Blog01s = new HashSet<Post0039>();
            Post0039Blog02s = new HashSet<Post0039>();
            Post0039Blog03s = new HashSet<Post0039>();
        }
        ...
        public virtual ICollection<Post0039> Post0039Blog00s { get; set; }
        public virtual ICollection<Post0039> Post0039Blog01s { get; set; }
        public virtual ICollection<Post0039> Post0039Blog02s { get; set; }
        public virtual ICollection<Post0039> Post0039Blog03s { get; set; }
    }
}
