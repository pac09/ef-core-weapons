...
namespace Models
{
    public partial class Blog0016
    {
        public Blog0016()
        {
            Post0016Blog00s = new HashSet<Post0016>();
            Post0016Blog01s = new HashSet<Post0016>();
            Post0016Blog02s = new HashSet<Post0016>();
            Post0016Blog03s = new HashSet<Post0016>();
        }
        ...
        public virtual ICollection<Post0016> Post0016Blog00s { get; set; }
        public virtual ICollection<Post0016> Post0016Blog01s { get; set; }
        public virtual ICollection<Post0016> Post0016Blog02s { get; set; }
        public virtual ICollection<Post0016> Post0016Blog03s { get; set; }
    }
}
