...
namespace Models
{
    public partial class Blog0085
    {
        public Blog0085()
        {
            Post0085Blog00s = new HashSet<Post0085>();
            Post0085Blog01s = new HashSet<Post0085>();
            Post0085Blog02s = new HashSet<Post0085>();
            Post0085Blog03s = new HashSet<Post0085>();
        }
        ...
        public virtual ICollection<Post0085> Post0085Blog00s { get; set; }
        public virtual ICollection<Post0085> Post0085Blog01s { get; set; }
        public virtual ICollection<Post0085> Post0085Blog02s { get; set; }
        public virtual ICollection<Post0085> Post0085Blog03s { get; set; }
    }
}
