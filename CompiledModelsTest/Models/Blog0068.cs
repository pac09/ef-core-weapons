...
namespace Models
{
    public partial class Blog0068
    {
        public Blog0068()
        {
            Post0068Blog00s = new HashSet<Post0068>();
            Post0068Blog01s = new HashSet<Post0068>();
            Post0068Blog02s = new HashSet<Post0068>();
            Post0068Blog03s = new HashSet<Post0068>();
        }
        ...
        public virtual ICollection<Post0068> Post0068Blog00s { get; set; }
        public virtual ICollection<Post0068> Post0068Blog01s { get; set; }
        public virtual ICollection<Post0068> Post0068Blog02s { get; set; }
        public virtual ICollection<Post0068> Post0068Blog03s { get; set; }
    }
}
