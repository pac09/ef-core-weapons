...
namespace Models
{
    public partial class Blog0003
    {
        public Blog0003()
        {
            Post0003Blog00s = new HashSet<Post0003>();
            Post0003Blog01s = new HashSet<Post0003>();
            Post0003Blog02s = new HashSet<Post0003>();
            Post0003Blog03s = new HashSet<Post0003>();
        }
        ...
        public virtual ICollection<Post0003> Post0003Blog00s { get; set; }
        public virtual ICollection<Post0003> Post0003Blog01s { get; set; }
        public virtual ICollection<Post0003> Post0003Blog02s { get; set; }
        public virtual ICollection<Post0003> Post0003Blog03s { get; set; }
    }
}
