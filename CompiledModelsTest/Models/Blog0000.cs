...
namespace Models
{
    public partial class Blog0000
    {
        public Blog0000()
        {
            Post0000Blog00s = new HashSet<Post0000>();
            Post0000Blog01s = new HashSet<Post0000>();
            Post0000Blog02s = new HashSet<Post0000>();
            Post0000Blog03s = new HashSet<Post0000>();
        }
        ...
        public virtual ICollection<Post0000> Post0000Blog00s { get; set; }
        public virtual ICollection<Post0000> Post0000Blog01s { get; set; }
        public virtual ICollection<Post0000> Post0000Blog02s { get; set; }
        public virtual ICollection<Post0000> Post0000Blog03s { get; set; }
    }
}
