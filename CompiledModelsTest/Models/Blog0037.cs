...
namespace Models
{
    public partial class Blog0037
    {
        public Blog0037()
        {
            Post0037Blog00s = new HashSet<Post0037>();
            Post0037Blog01s = new HashSet<Post0037>();
            Post0037Blog02s = new HashSet<Post0037>();
            Post0037Blog03s = new HashSet<Post0037>();
        }
        ...
        public virtual ICollection<Post0037> Post0037Blog00s { get; set; }
        public virtual ICollection<Post0037> Post0037Blog01s { get; set; }
        public virtual ICollection<Post0037> Post0037Blog02s { get; set; }
        public virtual ICollection<Post0037> Post0037Blog03s { get; set; }
    }
}
