...
namespace Models
{
    public partial class Blog0052
    {
        public Blog0052()
        {
            Post0052Blog00s = new HashSet<Post0052>();
            Post0052Blog01s = new HashSet<Post0052>();
            Post0052Blog02s = new HashSet<Post0052>();
            Post0052Blog03s = new HashSet<Post0052>();
        }
        ...
        public virtual ICollection<Post0052> Post0052Blog00s { get; set; }
        public virtual ICollection<Post0052> Post0052Blog01s { get; set; }
        public virtual ICollection<Post0052> Post0052Blog02s { get; set; }
        public virtual ICollection<Post0052> Post0052Blog03s { get; set; }
    }
}
