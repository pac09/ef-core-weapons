...
namespace Models
{
    public partial class Blog0061
    {
        public Blog0061()
        {
            Post0061Blog00s = new HashSet<Post0061>();
            Post0061Blog01s = new HashSet<Post0061>();
            Post0061Blog02s = new HashSet<Post0061>();
            Post0061Blog03s = new HashSet<Post0061>();
        }
        ...
        public virtual ICollection<Post0061> Post0061Blog00s { get; set; }
        public virtual ICollection<Post0061> Post0061Blog01s { get; set; }
        public virtual ICollection<Post0061> Post0061Blog02s { get; set; }
        public virtual ICollection<Post0061> Post0061Blog03s { get; set; }
    }
}
