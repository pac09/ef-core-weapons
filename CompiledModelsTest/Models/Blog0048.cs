...
namespace Models
{
    public partial class Blog0048
    {
        public Blog0048()
        {
            Post0048Blog00s = new HashSet<Post0048>();
            Post0048Blog01s = new HashSet<Post0048>();
            Post0048Blog02s = new HashSet<Post0048>();
            Post0048Blog03s = new HashSet<Post0048>();
        }
        ...
        public virtual ICollection<Post0048> Post0048Blog00s { get; set; }
        public virtual ICollection<Post0048> Post0048Blog01s { get; set; }
        public virtual ICollection<Post0048> Post0048Blog02s { get; set; }
        public virtual ICollection<Post0048> Post0048Blog03s { get; set; }
    }
}
