...
namespace Models
{
    public partial class Blog0071
    {
        public Blog0071()
        {
            Post0071Blog00s = new HashSet<Post0071>();
            Post0071Blog01s = new HashSet<Post0071>();
            Post0071Blog02s = new HashSet<Post0071>();
            Post0071Blog03s = new HashSet<Post0071>();
        }
        ...
        public virtual ICollection<Post0071> Post0071Blog00s { get; set; }
        public virtual ICollection<Post0071> Post0071Blog01s { get; set; }
        public virtual ICollection<Post0071> Post0071Blog02s { get; set; }
        public virtual ICollection<Post0071> Post0071Blog03s { get; set; }
    }
}
