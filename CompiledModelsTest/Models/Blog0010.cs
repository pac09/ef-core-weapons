...
namespace Models
{
    public partial class Blog0010
    {
        public Blog0010()
        {
            Post0010Blog00s = new HashSet<Post0010>();
            Post0010Blog01s = new HashSet<Post0010>();
            Post0010Blog02s = new HashSet<Post0010>();
            Post0010Blog03s = new HashSet<Post0010>();
        }
        ...
        public virtual ICollection<Post0010> Post0010Blog00s { get; set; }
        public virtual ICollection<Post0010> Post0010Blog01s { get; set; }
        public virtual ICollection<Post0010> Post0010Blog02s { get; set; }
        public virtual ICollection<Post0010> Post0010Blog03s { get; set; }
    }
}
