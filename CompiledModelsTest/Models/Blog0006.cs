...
namespace Models
{
    public partial class Blog0006
    {
        public Blog0006()
        {
            Post0006Blog00s = new HashSet<Post0006>();
            Post0006Blog01s = new HashSet<Post0006>();
            Post0006Blog02s = new HashSet<Post0006>();
            Post0006Blog03s = new HashSet<Post0006>();
        }
        ...
        public virtual ICollection<Post0006> Post0006Blog00s { get; set; }
        public virtual ICollection<Post0006> Post0006Blog01s { get; set; }
        public virtual ICollection<Post0006> Post0006Blog02s { get; set; }
        public virtual ICollection<Post0006> Post0006Blog03s { get; set; }
    }
}
