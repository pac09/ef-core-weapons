...
namespace Models
{
    public partial class Blog0015
    {
        public Blog0015()
        {
            Post0015Blog00s = new HashSet<Post0015>();
            Post0015Blog01s = new HashSet<Post0015>();
            Post0015Blog02s = new HashSet<Post0015>();
            Post0015Blog03s = new HashSet<Post0015>();
        }
        ...
        public virtual ICollection<Post0015> Post0015Blog00s { get; set; }
        public virtual ICollection<Post0015> Post0015Blog01s { get; set; }
        public virtual ICollection<Post0015> Post0015Blog02s { get; set; }
        public virtual ICollection<Post0015> Post0015Blog03s { get; set; }
    }
}
