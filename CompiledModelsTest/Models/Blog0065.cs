...
namespace Models
{
    public partial class Blog0065
    {
        public Blog0065()
        {
            Post0065Blog00s = new HashSet<Post0065>();
            Post0065Blog01s = new HashSet<Post0065>();
            Post0065Blog02s = new HashSet<Post0065>();
            Post0065Blog03s = new HashSet<Post0065>();
        }
        ...
        public virtual ICollection<Post0065> Post0065Blog00s { get; set; }
        public virtual ICollection<Post0065> Post0065Blog01s { get; set; }
        public virtual ICollection<Post0065> Post0065Blog02s { get; set; }
        public virtual ICollection<Post0065> Post0065Blog03s { get; set; }
    }
}
