...
namespace Models
{
    public partial class Blog0044
    {
        public Blog0044()
        {
            Post0044Blog00s = new HashSet<Post0044>();
            Post0044Blog01s = new HashSet<Post0044>();
            Post0044Blog02s = new HashSet<Post0044>();
            Post0044Blog03s = new HashSet<Post0044>();
        }
        ...
        public virtual ICollection<Post0044> Post0044Blog00s { get; set; }
        public virtual ICollection<Post0044> Post0044Blog01s { get; set; }
        public virtual ICollection<Post0044> Post0044Blog02s { get; set; }
        public virtual ICollection<Post0044> Post0044Blog03s { get; set; }
    }
}
