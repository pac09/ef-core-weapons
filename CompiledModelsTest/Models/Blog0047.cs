...
namespace Models
{
    public partial class Blog0047
    {
        public Blog0047()
        {
            Post0047Blog00s = new HashSet<Post0047>();
            Post0047Blog01s = new HashSet<Post0047>();
            Post0047Blog02s = new HashSet<Post0047>();
            Post0047Blog03s = new HashSet<Post0047>();
        }
        ...
        public virtual ICollection<Post0047> Post0047Blog00s { get; set; }
        public virtual ICollection<Post0047> Post0047Blog01s { get; set; }
        public virtual ICollection<Post0047> Post0047Blog02s { get; set; }
        public virtual ICollection<Post0047> Post0047Blog03s { get; set; }
    }
}
