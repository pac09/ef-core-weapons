...
namespace Models
{
    public partial class Blog0062
    {
        public Blog0062()
        {
            Post0062Blog00s = new HashSet<Post0062>();
            Post0062Blog01s = new HashSet<Post0062>();
            Post0062Blog02s = new HashSet<Post0062>();
            Post0062Blog03s = new HashSet<Post0062>();
        }
        ...
        public virtual ICollection<Post0062> Post0062Blog00s { get; set; }
        public virtual ICollection<Post0062> Post0062Blog01s { get; set; }
        public virtual ICollection<Post0062> Post0062Blog02s { get; set; }
        public virtual ICollection<Post0062> Post0062Blog03s { get; set; }
    }
}
