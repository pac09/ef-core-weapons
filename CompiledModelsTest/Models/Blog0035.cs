...
namespace Models
{
    public partial class Blog0035
    {
        public Blog0035()
        {
            Post0035Blog00s = new HashSet<Post0035>();
            Post0035Blog01s = new HashSet<Post0035>();
            Post0035Blog02s = new HashSet<Post0035>();
            Post0035Blog03s = new HashSet<Post0035>();
        }
        ...
        public virtual ICollection<Post0035> Post0035Blog00s { get; set; }
        public virtual ICollection<Post0035> Post0035Blog01s { get; set; }
        public virtual ICollection<Post0035> Post0035Blog02s { get; set; }
        public virtual ICollection<Post0035> Post0035Blog03s { get; set; }
    }
}
