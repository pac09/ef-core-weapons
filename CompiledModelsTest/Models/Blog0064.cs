...
namespace Models
{
    public partial class Blog0064
    {
        public Blog0064()
        {
            Post0064Blog00s = new HashSet<Post0064>();
            Post0064Blog01s = new HashSet<Post0064>();
            Post0064Blog02s = new HashSet<Post0064>();
            Post0064Blog03s = new HashSet<Post0064>();
        }
        ...
        public virtual ICollection<Post0064> Post0064Blog00s { get; set; }
        public virtual ICollection<Post0064> Post0064Blog01s { get; set; }
        public virtual ICollection<Post0064> Post0064Blog02s { get; set; }
        public virtual ICollection<Post0064> Post0064Blog03s { get; set; }
    }
}
