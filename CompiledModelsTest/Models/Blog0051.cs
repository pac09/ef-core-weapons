...
namespace Models
{
    public partial class Blog0051
    {
        public Blog0051()
        {
            Post0051Blog00s = new HashSet<Post0051>();
            Post0051Blog01s = new HashSet<Post0051>();
            Post0051Blog02s = new HashSet<Post0051>();
            Post0051Blog03s = new HashSet<Post0051>();
        }
        ...
        public virtual ICollection<Post0051> Post0051Blog00s { get; set; }
        public virtual ICollection<Post0051> Post0051Blog01s { get; set; }
        public virtual ICollection<Post0051> Post0051Blog02s { get; set; }
        public virtual ICollection<Post0051> Post0051Blog03s { get; set; }
    }
}
