...
namespace Models
{
    public partial class Blog0080
    {
        public Blog0080()
        {
            Post0080Blog00s = new HashSet<Post0080>();
            Post0080Blog01s = new HashSet<Post0080>();
            Post0080Blog02s = new HashSet<Post0080>();
            Post0080Blog03s = new HashSet<Post0080>();
        }
        ...
        public virtual ICollection<Post0080> Post0080Blog00s { get; set; }
        public virtual ICollection<Post0080> Post0080Blog01s { get; set; }
        public virtual ICollection<Post0080> Post0080Blog02s { get; set; }
        public virtual ICollection<Post0080> Post0080Blog03s { get; set; }
    }
}
